...
if($lc == "1"){
  header("Location:/Projects/Blade-test/test_BladeOne/BladeOne/english1learner.php");
} else if($lc == "2") {
  header("Location:/Projects/Blade-test/test_BladeOne/BladeOne/english2learner.php");
} else {
header("Location:/Projects/Blade-test/test_BladeOne/BladeOne/english3learner.php");
}
