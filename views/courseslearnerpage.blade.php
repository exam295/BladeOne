      ...
      <div class="card-deck mb-3 text-center">
        <div class="card mb-4 box-shadow">
          <div class="card-header">
            <h4 class="my-0 font-weight-normal" id="maths1">Maths</h4>
          </div>
            <div class="card-body">
                <h1 class="card-title pricing-card-title">Maths content and Quiz <small class="text-muted"> Yay!</small></h1>
                ...
                <a href="php/mathsredirect.php" button type="button" class="btn btn-lg btn-block btn-outline-primary" >Continue</a>
            </div>
        </div>
        <div class="card mb-4 box-shadow">
          <div class="card-header">
          ...
          <div class="card-body">
          <h1 class="card-title pricing-card-title">English content and Quiz<small class="text-muted">Yay!</small></h1>
            <ul class="list-unstyled mt-3 mb-4">
              <li>Dummy Text</li>
              <li>Dummy Text</li>
              <li>Dummy Text</li>
            ...
            <a href="php/englishredirect.php" button type="button" class="btn btn-lg btn-block btn-outline-primary" >Continue</a>
          </div>
        </div>
        <div class="card mb-4 box-shadow">
          <div class="card-header">
          ...
          <div class="card-body">
          <h1 class="card-title pricing-card-title">Science content and Quiz <small class="text-muted">Yay!</small></h1>
            <ul class="list-unstyled mt-3 mb-4">
              <li>Dummy Text</li>
              <li>Dummy Text</li>
              <li>Dummy Text</li>
            ...
            <a href="php/scienceredirect.php" button type="button" class="btn btn-lg btn-block btn-outline-primary" >Continue</a>
          </div>
        </div>
      </div>
    </div>
...
<script type="text/javascript">
        document.getElementById("maths1").onload = function() {
            document.getElementById("maths1").style.display = "none";
