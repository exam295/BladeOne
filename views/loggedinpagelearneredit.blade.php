        ...
        <div class="padding">
			<div class="row">
				...
				<div class="col-lg-8">
					...
					$id = $row["LearnerID"];
                    ?>
					<input type="text" class="form-control" name="usernameupdate" value="<?php $row['LearnerUsername']; ?>">
                    <?php
                    $querey = mysqli_query($conn, 'UPDATE registered_learners  SET lastname = usernameupdate  WHERE LearnerID like "%'. $id . '%"');
                    ?>
								</div>
							</div>
							<div class="row mb-3">
					...
					$id = $row["LearnerID"];
                    ?>
					<input type="text" class="form-control" value="<?php $row['LearnerUsername']; ?>">	
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm-3">
